                            ...
                            <tbody>
                                @foreach ($athletes as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <form class="d-inline" action="{{ url('unvalidate/valid') }}" method="post">
                                                @csrf
                                                @method('PUT')
                                                <button class="btn icon btn-sm btn-success" type="submit" name="id"
                                                    value="{{ $data->id }}"><i class="bi bi-check"></i></button>
                                            </form>
                                            <form class="d-inline" action="{{ url('unvalidate/invalid') }}" method="post">
                                                @csrf
                                                @method('DELETE')
